 ...
 class CreateDateControl {
     ...
     getWeek(year, month, week) {
         ...
         let day = new Date(weekVal).getDay();
         switch (day) {
             case 0:
                 return "星期日";
             case 1:
     ...
     changeYear() {
         ...
         let This = this;
         Array.from(ulYearLi).forEach(li => {
             li.addEventListener("click", function (e) {
                 This.changenClick = true;
                 Array.from(ulYearLi).forEach(removeClassLi => {
     ...
     changeMonth() {
         ...
         let This = this;
         Array.from(ulMonthLi).forEach(li => {
             li.addEventListener("click", function (e) {
                 This.changenClick = true;
                 Array.from(ulMonthLi).forEach(removeClassLi => {
                     removeClassLi.setAttribute("class", "");
                 });
     ...
     changeEvent() {
         ...
         Array.from(header_inputList).forEach(header_input => {
             header_input.addEventListener("click", function (e) {
                 ...
                 let input_ul = this.nextElementSibling || this.nextSibling;
